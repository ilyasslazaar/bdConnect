...
import { getEntities, reset } from './query.reducer';
...
export type IQueryState = IPaginationBaseState;
...
export class Query extends React.Component<IQueryProps, IQueryState> {
  ...
  render() {
    const { queryList, match } = this.props;
    return (
      <div>
        <h2 id="query-heading">
          Queries
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('statment')}>
                    Statment <FontAwesomeIcon icon="sort" />
                  </th>
